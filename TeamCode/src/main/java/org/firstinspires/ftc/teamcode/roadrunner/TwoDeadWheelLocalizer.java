...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2938.689510626902; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 6722.011158508966; // x position of the perpendicular encoder (in tick units)
    }
