//package org.firstinspires.ftc.teamcode.pedropathing.tuners_test.localization;
//
...
// * robot's current initAngle in ticks to the specified initAngle in radians. So, to use this, run the
// * tuner, then pull/push the robot to the specified initAngle using a protractor or lines on the ground.
// * When you're at the end of the initAngle, record the ticks to inches multiplier. Feel free to run
...
// * You can adjust the target initAngle on FTC Dashboard: 192/168/43/1:8080/dash
// *
...
//        poseUpdater.update();
//
//        telemetryA.addData("total initAngle", poseUpdater.getTotalHeading());
//        telemetryA.addLine("The multiplier will display what your turn ticks to inches should be to scale your current initAngle to " + ANGLE + " radians.");
